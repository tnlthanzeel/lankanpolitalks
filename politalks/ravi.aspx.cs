...
namespace politalks
{
    public partial class ravi : System.Web.UI.Page
    {
        ...
        private void fillData()
        {
            ...
            SqlDataAdapter adapt = new SqlDataAdapter("Select * from tbl_Comment4 Order by Id Desc", con);
            adapt.Fill(dt);
            con.Close();
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into tbl_Comment4(Name,Email,Comment) values(@name,@email,@comment)";
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "alert('Comment Posted Successfully.');window.location='ravi.aspx';", true);
            fillData();
            txtComment.Text = "";
